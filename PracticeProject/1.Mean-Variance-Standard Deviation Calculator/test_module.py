...
class UnitTests(unittest.TestCase):
    ...
    def test_calculate2(self):
        ...
        self.assertAlmostEqual(actual, expected, "Expected different output when calling 'calculate()' with '[9,1,5,3.Medical Data Visualizer,3.Medical Data Visualizer,3.Medical Data Visualizer,2,9,0]'")
